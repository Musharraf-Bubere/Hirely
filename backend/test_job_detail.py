...
try:
    ...
    # ---------------------------------------------------------
    response = client.get(
        f"/jobs/{active_job.id}",
    )

    print("Active job → GET /jobs/{id}:", response.status_code)
    ...
    # ---------------------------------------------------------
    response = client.get(
        f"/jobs/{inactive_job.id}",
    )

    print(
        "Inactive job → GET /jobs/{id}:",
    ...
    response = client.get(
        f"/jobs/{nonexistent_job_id}",
    )

    print(
        "Nonexistent job → GET /jobs/{id}:",
        response.status_code,
    )
    print("Response:", response.json())
    ...
    print("Temporary job detail test data cleaned up.")