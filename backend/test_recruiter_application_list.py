...
try:
    ...
    print(
        "Recruiter A → GET /applications/recruiter:",
    ...
    print("Recruiter A ownership test passed.")
    ...
    print(
        "Recruiter B → GET /applications/recruiter:",
        response.status_code,
    )
    print("Response:", response.json())
    ...
    print("Recruiter B ownership test passed.")
    ...
    print(
        "Candidate → GET /applications/recruiter:",
        response.status_code,
    )
    print("Response:", response.json())
    ...
    print("Recruiter application listing tests passed.")
    ...
    print("Temporary recruiter application test data cleaned up.")